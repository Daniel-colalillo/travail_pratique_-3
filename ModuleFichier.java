...
public class ModuleFichier {
	...
	/**
	   ...
	   /**
	    * gÈnÈrer au hasard les supporteurs des partie
	    * 
	   ...
	   public static void genererSupporteurs(Election election){
		    ...
		    /*
			 * strategie: 
			 * vÈrifie ‡ quelle partie appartient chaque supporter et 
			 * l'ajoute ‡ la collection correcte.
			 * 
			 */
		   
		   // gÈnÈrer des partis pour autant de partis existent
		   for(int i = 0; i < election.getnumeroDePartiCollection(); i++){
			   Parti parti = election.partiCollection.get(i);
			   
			   // vÈrifier ‡ quelle catÈgorie appartient le parti
			   // gÈnÈrer des supporters pour chaque catÈgorie
	   ...
	   /**
	    * gÈnÈrer au hasard les supporteurs du parti de gauche
	    * 
	   ...
	   public static void genererSupOBNL(PartiDeGauche parti){
		    ...
		    /*
			 * strategie: 
			 * en utilisant utilitaireMath gÈnÈrer un nombre de chaine vide 
			 * alÈatoire et l'ajouter ‡ la collection obnl
			 * 
			 */
	   ...
	   /**
	    * gÈnÈrer au hasard les supporteurs du parti du centre
	    * 
	   ...
	   public static void generezSupCirconscritpion(PartiDuCentre parti, 
		   ...
		   /*
			 * strategie: 
			 * gÈnÈrer un nombre alÈatoire de supporters et une partie 
			 * alÈatoire pour eux en utilisant utilitairemath, vÈrifie 
			 * Ègalement si les parties doublent et, en utilisant une 
			 * boucle while, gÈnËre une partie alÈatoire jusqu'‡ ce qu'une 
			 * partie non prise soit gÈnÈrÈe
			 * 
			 */
		   
		   // gÈnÈrer un nombre alÈatoire de supporteurs
	   ...
	   /**
	    * gÈnÈrer au hasard les supporteurs du parti de droite
	    * 
